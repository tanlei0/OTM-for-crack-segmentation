...
def create_model(num_classes, load_pretrain_weights=True, pretrain_root= ".",use_best_thr = False):
    ...
    if pretrain_root != "":
        ...
        backbone = resnet50_fpn_backbone("", trainable_layers=5,norm_layer=FrozenBatchNorm2d)

    model = MaskRCNN(backbone, num_classes=num_classes, use_best_thr=use_best_thr)
    # print(model)
...
def main(args):
    ...
    if OTM:
        model = create_model(num_classes=args.num_classes + 1, load_pretrain_weights=args.pretrain, use_best_thr=True)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--OTM", default=False, help="Switching of OTM", type=bool)
    parser.add_argument("--othrs", default="", help="the othrs file for training OTM")
